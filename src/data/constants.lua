...
CCommunityFarmBuildingEffect = 25
...
CWearRate = .0002 -- 1.0 = every vehicle wears (to 100%) one square meter of road every second
CRepairCost = 0.05 -- times purchase cost of road
...
CMemoriesForFiveStars = 1 -- per tourist per hour
CTouristStay0 = 1;
CTouristStay5 = 5;
...
CLitersPerMinuteBus = 0.15 -- fuel used by a bus driven for 1 minute
CLitersPerMinuteCar = 0.05 -- fuel used by a car driven for 1 minute
